...
import org.course_management_system.security.service.JwtService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        return "/auth/login".equals(request.getRequestURI()) && "POST".equals(request.getMethod())
               || "/student/register".equals(request.getRequestURI()) && "POST".equals(request.getMethod())
               || "/instructor/register".equals(request.getRequestURI()) && "POST".equals(request.getMethod())
